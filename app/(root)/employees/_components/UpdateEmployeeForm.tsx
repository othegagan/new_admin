...
export default function UpdateEmployeeForm({ cell }: { cell: any }) {
    ...
    return (
        <div className='flex-center'>
            ...
            {selectedRow && (
                <AdaptiveDialog isOpen={open} onClose={handleClose} title='Edit Employee' description='Edit Employee details'>
