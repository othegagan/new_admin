    ...
    return (
        <div className={cn('group flex items-center text-nowrap', isActive && 'rounded-full bg-primary/80')}>
            <Link
                ...
                className={cn(
                    'inline-flex h-9 items-center justify-center rounded-r-none rounded-l-full pr-2 pl-4 font-medium text-sm duration-75 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring',
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button
                        ...
                        type='button'
                        className={cn(
                            'h-9 rounded-r-full rounded-l-none pr-3 pl-2 font-medium text-sm shadow-sm duration-75 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring',
                            isActive
