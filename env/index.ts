...
const clientEnv = createEnv({
    ...
    client: {
        ...
        NEXT_PUBLIC_NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN: z.string(),
    ...
    experimental__runtimeEnv: {
        ...
        NEXT_PUBLIC_NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN: process.env.NEXT_PUBLIC_NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN,
