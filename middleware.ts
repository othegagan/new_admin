...
const routeMatcher = createRouterMatcher([
    ...
    { matcher: `${PAGE_ROUTES.TRIPS}${PAGE_ROUTES.TRIPS_TABS.ALL_TRIPS}`, auth: true },
    { matcher: `${PAGE_ROUTES.TRIPS}${PAGE_ROUTES.TRIPS_TABS.DAILY_VIEW}`, auth: true },
    { matcher: `${PAGE_ROUTES.TRIPS}${PAGE_ROUTES.TRIPS_TABS.REVIEW_REUIRED}`, auth: true },
